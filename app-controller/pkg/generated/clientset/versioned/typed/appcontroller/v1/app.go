...
import (
	...
	scheme "github.com/istudies/k8s-operator/app-controller/pkg/generated/clientset/versioned/scheme"
...
func newApps(c *AppcontrollerV1Client, namespace string) *apps {
	return &apps{
		client: c.RESTClient(),
		ns:     namespace,
	}
