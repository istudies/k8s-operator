...
import (
	...
	versioned "github.com/istudies/k8s-operator/app-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/istudies/k8s-operator/app-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/istudies/k8s-operator/app-controller/pkg/generated/listers/appcontroller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppcontrollerV1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppcontrollerV1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&appcontrollerv1.App{},
		resyncPeriod,
...
func (f *appInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appcontrollerv1.App{}, f.defaultInformer)
}
