...
import (
	...
	versioned "github.com/istudies/k8s-operator/code-gen-crds/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/istudies/k8s-operator/code-gen-crds/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/istudies/k8s-operator/code-gen-crds/pkg/generated/listers/mycrds.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MycrdsV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MycrdsV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&mycrdscomv1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mycrdscomv1.Foo{}, f.defaultInformer)
}
